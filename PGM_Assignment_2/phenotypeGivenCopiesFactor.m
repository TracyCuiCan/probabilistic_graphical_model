...
for i=1:(2*numAlleles*numAlleles)
    IDs=IndexToAssignment(i,phenotypeFactor.card);
    if IDs(1)==1
        phenotypeFactor.val(i)=alphaList(allelesToGenotypes(IDs(2),IDs(3)));
    else
        phenotypeFactor.val(i)=1-alphaList(allelesToGenotypes(IDs(2),IDs(3)));
    end
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%